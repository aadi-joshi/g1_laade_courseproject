...
# the following code is for zero variance features
# these are features with constant values (constant values)
variance = X.var()
...
# reduce dimensionality while retaining 95% of the data's variance
